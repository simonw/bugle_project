...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        db.add_column('bugle_blast', 'in_reply_to', self.gf('django.db.models.fields.related.ForeignKey')(to=orm['bugle.Blast'], null=True, blank=True), keep_default=False)


    def backwards(self, orm):
        
        # Deleting field 'Blast.in_reply_to'
        db.delete_column('bugle_blast', 'in_reply_to_id')
    ...
    models = {
        ...
        'bugle.blast': {
            ...
            'id': ('django.db.models.fields.AutoField', [], {'primary_key': 'True'}),
            'in_reply_to': ('django.db.models.fields.related.ForeignKey', [], {'to': "orm['bugle.Blast']", 'null': 'True', 'blank': 'True'}),
